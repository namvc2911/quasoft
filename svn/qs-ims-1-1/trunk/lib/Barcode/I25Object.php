...
class Qss_lib_Barcode_I25Object extends Qss_Lib_Barcode_Barcode
{

	var $mCharSet;

	function Qss_lib_Barcode_I25Object ($Width, $Height, $Style, $Value)
	{
		$this->Qss_Lib_Barcode_Barcode($Width, $Height, $Style);
		$this->mValue = $Value;
		$this->mCharSet = array
	 (						
	   /* 0 */ "00110",
