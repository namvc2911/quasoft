 ...
 */
class Static_M877Controller extends Qss_Lib_Controller
{
    // property
    ...
    public function showAction()
    {
        ...
        if($year)
        {
            ...
            $this->html->report           = $model->getData($year, $locationIOID, $eqGroupIOID, $eqTypeIOID, $equipIOID, $workcenter);
