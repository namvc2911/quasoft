<?php
class Static_M834Controller extends Qss_Lib_Controller
{
    ...
    public function showAction()
    {
        ...
        $hasplan        = $this->params->requests->getParam('hasplan', 0);

        $report         = $mMaintain->getThucHienKeHoachVanHanhSuaChuaBaoDuong(
