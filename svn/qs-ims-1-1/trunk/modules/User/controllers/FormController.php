		...
		/*if($this->_mobile)
			{
				$this->html->setHtml(dirname(dirname(__FILE__)).'/html/form/edit_m.phtml');
		*/
		$ifids = $this->params->requests->getParam('ifids', array());
		$deptids = $this->params->requests->getParam('deptids', array());
...
||||||| .r9514
		...
		{
=======
		if($ifid && $form->initData($ifid, $this->_user->user_dept_id) && $this->b_fCheckRightsOnForm($form,4))
		{
>>>>>>> .r9624
