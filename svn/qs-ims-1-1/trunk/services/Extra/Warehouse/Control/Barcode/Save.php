...
class Qss_Service_Extra_Warehouse_Control_Barcode_Save extends Qss_Service_Abstract
{
	...
	{		
		...
		if($this->validate($params))
		{
			...
			$insert['OXuatKho'][0]['MaNCC'] = $params['partner'];
			...
			{
				//ThuocTinh
				$insert['ODanhSachXuatKho'][$i]['MaSanPham'] = $params['ItemCode'][$i];
