...
class Static_M743Controller extends Qss_Lib_Controller
{
	...
	{
		$locIOID        = (int)$this->params->requests->getParam('location', 0);
		$eqGroupIOID    = (int)$this->params->requests->getParam('group', 0);
		$eqTypeIOID     = (int)$this->params->requests->getParam('type', 0);
		$eqIOID         = (int)$this->params->requests->getParam('equipment', 0);
        ...
        $this->html->group = $eqGroupIOID;
        $this->html->location = $locIOID;
