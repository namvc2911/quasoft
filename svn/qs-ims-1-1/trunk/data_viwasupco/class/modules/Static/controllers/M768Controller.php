...
class Static_M768Controller extends Qss_Lib_Controller
{
	...
	public function showAction()
	{
        ...
        $materialIOID  = $this->params->requests->getParam('material');
        ...
        $maintainModel = new Qss_Model_M724_Plan();
        $materialPlans = $maintainModel->getMaterialsPlansOrderByRootLocationAndEquipName($mSDate, $mEDate, $locIOID , $eqGroupIOID , $eqTypeIOID, $materialIOID);
