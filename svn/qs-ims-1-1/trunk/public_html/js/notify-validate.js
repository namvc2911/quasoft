...
{
    var url = sz_BaseUrl + '/notify/validate/edit?action=1&fid=' + fid;
...
{
	var url = sz_BaseUrl + '/notify/validate/delete';
...
function saveNotify()
{
	var url = sz_BaseUrl + '/notify/validate/save';
...
function runNotify(fid) {
	qssAjax.confirm(Language.translate('CONFIRM_PROCESS'),function(){
		var url = sz_BaseUrl + '/notify/validate/run';
		var data = {fid:fid};
		qssAjax.call(url, data, function(jreturn) {
