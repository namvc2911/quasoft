...
{
    var url = sz_BaseUrl + '/notify/sms/edit?action=1&fid=' + fid;
...
{
	var url = sz_BaseUrl + '/notify/sms/delete';
...
function saveNotify()
{
	var url = sz_BaseUrl + '/notify/sms/save';
...
function runNotify(fid) {
	qssAjax.confirm(Language.translate('CONFIRM_PROCESS'),function(){
		var url = sz_BaseUrl + '/notify/sms/run';
		var data = {fid:fid};
		qssAjax.call(url, data, function(jreturn) {
