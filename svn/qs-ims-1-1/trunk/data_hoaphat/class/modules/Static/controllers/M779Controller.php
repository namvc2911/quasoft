...
class Static_M779Controller extends Qss_Lib_Controller
{
    ...
    public function indexAction() {
        ...
        $locations = $mLoc->getLocationByCurrentUser();

        // Lấy các khu vực user có quyền để đưa vào điều kiện lọc của combobox khu vực
        ...
        $this->html->where = ($where)?sprintf('and (%1$s)',$where):'and 0 = 1';
    }
    ...
    public function showAction() {
        ...
        $this->getWorkOrder($date, $enddate, $location, $equip); // Lấy phiếu bảo trì
    ...
    private function getWorkOrder($startdate, $enddate,$location, $equip)
    {
    ...
    protected function getMaintainDataForMaintainOrder($date, $location, $equipIOID,&$row = 0 )
    {
