...
//        $this->html->report = $report;
        ...
        $mPlan = new Qss_Model_Mtsmaintain();
        ...
        $end      = $this->params->requests->getParam('end', '');
        $location = $this->params->requests->getParam('location', '');
        $this->html->report = ($year)?$mPlan->getTheoDoiThucHienBaoTri($year, $location, $type):array();
        ...
        foreach($this->html->report as $item) {
            ...
            $sum[$key0]['TongSoKeHoach'] += $item->TongSoKeHoach?$item->TongSoKeHoach:0;
            ...
            $sum[$key1]['TongSoKeHoach'] += $item->TongSoKeHoach?$item->TongSoKeHoach:0;
            ...
            $sum[$key2]['TongSoKeHoach'] += $item->TongSoKeHoach?$item->TongSoKeHoach:0;
            ...
            $sum[$key3]['TongSoKeHoach'] += $item->TongSoKeHoach?$item->TongSoKeHoach:0;
            ...
            $sum['total']['TongSoKeHoach'] += $item->TongSoKeHoach?$item->TongSoKeHoach:0;
