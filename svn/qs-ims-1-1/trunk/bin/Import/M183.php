<?php
class Qss_Bin_Import_M183 extends Qss_Lib_Bin
{
	public function __doExecute()
	{
		...
		if($ifid)
		{
            ...
            $sql = sprintf('update OChiTietThuHoiTaiSan as v 
					...
					where v.IFID_M183=%1$d AND IFNULL(v.DonGia, "") = ""',$ifid);
            $this->_db->execute($sql);
