<?php
class Qss_Bin_Trigger_ODSDonBanHang extends Qss_Lib_Trigger
{
	/**
	 * Tax
	 */
	...
	private function updateTax($object) 
	{
		...
		$taxs = $model->getTaxsOrder($object->i_IFID);
		$aTaxs = array();
		...
		$service = $this->services->Form->Manual('M505',$object->i_IFID,$params,false);
		//var_dump($params); die;
		if($service->isError())
		{
			$this->setError();
