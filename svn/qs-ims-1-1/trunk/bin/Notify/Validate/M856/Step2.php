<?php
class Qss_Bin_Notify_Validate_M856_Step2 extends Qss_Lib_Notify_Mail
{
	const TITLE ='Cập nhật khi gửi thông báo';
	 ...
	 if(Qss_Lib_System::formActive('M856'))
		{
			$sql = sprintf('
	            ...
	            SET qsusers.Notify = ifnull(t.TongSo,0) + ifnull(t1.TongSo,0)
	        ', $user->user_id);
