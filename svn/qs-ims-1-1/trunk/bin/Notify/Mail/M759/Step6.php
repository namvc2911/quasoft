<?php
class Qss_Bin_Notify_Mail_M759_Step6 extends Qss_Lib_Notify_Mail
{
	const TITLE ='Gửi email khi gửi duyệt kế hoạch phiếu bảo trì';
	...
	public function __doExecute($user,$status,$comment)
	{
        ...
        if($loaiBaoTriCoGuiMail)
        {
            ...
            {
                $subject  = '[QS-M759] Gửi duyệt kế hoạch phiếu ';
