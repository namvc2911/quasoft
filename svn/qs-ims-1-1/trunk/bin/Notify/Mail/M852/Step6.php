<?php
class Qss_Bin_Notify_Mail_M852_Step6 extends Qss_Lib_Notify_Mail
{
    const TITLE ='Gửi email khi chuyển sang chờ';
    ...
    public function __doExecute($user,$status,$comment)
    {
        ...
        {
            $subject = '['. $this->_params->DuAn .'] Chờ '. $this->_params->SoPhieu;
