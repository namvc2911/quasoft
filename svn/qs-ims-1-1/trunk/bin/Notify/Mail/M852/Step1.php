<?php
class Qss_Bin_Notify_Mail_M852_Step1 extends Qss_Lib_Notify_Mail
{
    const TITLE ='Gửi email chuyển về soạn thảo';
    ...
    public function __doExecute($user,$status,$comment)
    {
        ...
        {
            $subject = '['. $this->_params->DuAn .'] Bắt đầu thực hiện '. $this->_params->SoPhieu;

            $body  = '<h1>Chuyển lại soạn thảo '. $this->_params->SoPhieu.'</h1>';
