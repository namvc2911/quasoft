<?php
class Qss_Bin_Calculate_OTraLaiTaiSanCaNhan_GiaTriKhauHao extends Qss_Lib_Calculate
{
	public function __doExecute()
	{
		...
		return round((($giatriconlai/$soluongbangiao)/$khauhaobangiao)*$soluongtralai*$khauhao);
	}
}
?>