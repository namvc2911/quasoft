 ...
 *
 */
class Qss_View_Instance_Object_Mobile extends Qss_View_Abstract
{
    ...
    public function __doExecute (Qss_Model_Object $object, Qss_Model_UserInfo $user,$dialog = false)
    {
        ...
        if ( !is_dir(QSS_DATA_DIR . '/views/mobile/object/') )
        {
            mkdir(QSS_DATA_DIR . '/views/mobile/object/');
        }
        $sz_FileName = QSS_DATA_DIR . '/views/mobile/object/' . $object->ObjectCode . '.phtml';
        $sz_FileName = Qss_Lib_Template::b_fGenerateObjectMobile($object, $sz_FileName,$dialog);
