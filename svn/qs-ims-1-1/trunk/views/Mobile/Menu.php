<?php
class Qss_View_Mobile_Menu extends Qss_View_Abstract
{
					...
					foreach ($menulist as $item)
					{
						if($o_User->hasChild($item->MenuID))
						{
							...
							foreach ($menuitem as $o_Form)
							{
								...
								if($o_Form->classMobile && $o_Form->Type != Qss_Lib_Const::FORM_TYPE_PROCESS)
								{
									$newsubitem->setAttribute("href", Qss_Params::getInstance()->requests->getBaseUrl() .$o_Form->classMobile);
