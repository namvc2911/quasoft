<?php
class Qss_Bin_Notify_Mail_M506_Step4 extends Qss_Lib_Notify_Mail
{
	const TITLE ='Gửi email khi gửi đề nghị duyệt vật tư bảo trì';
	...
	public function __doExecute($user,$status,$comment)
	{
		...
		$phieuyc  = '';
		$phieuyc .= "<p>Phiếu yêu cầu xuất kho vật tư <strong>";
