<?php
class Qss_Bin_Notify_Mail_M759_Step3 extends Qss_Lib_Notify_Mail
{
    const TITLE ='Gửi email khi chuyển tình trạng "Hoàn thành"';
    ...
    public function __doExecute($user,$status,$comment)
    {
        ...
        if($loaiBaoTriCoGuiMail)
        {
            ...
            {
                $subject  = '[QS-M759] Hoàn thành phiếu ';
