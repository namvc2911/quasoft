<?php
class Qss_Bin_Notify_Mail_M852_Comment extends Qss_Lib_Notify_Mail
{
	const TYPE = 'TRIGGER';
	...
	public function __doExecute($user,$comment)
	{
		$domain = $_SERVER['HTTP_HOST'];
			...
			{
                $subject = '['. $this->_params->DuAn .'] Phản hồi '. $this->_params->SoPhieu;

                $body  = '<h1>Phản hồi '. $this->_params->SoPhieu.'</h1>';
