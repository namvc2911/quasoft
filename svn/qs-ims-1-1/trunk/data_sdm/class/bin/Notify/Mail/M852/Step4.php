<?php
class Qss_Bin_Notify_Mail_M852_Step4 extends Qss_Lib_Notify_Mail
{
	const TITLE ='Gửi email xác nhận đã nghiệm thu';
	...
	public function __doExecute($user,$status,$comment)
	{
		$domain = $_SERVER['HTTP_HOST'];
			...
			{
				$subject = '['. $this->_params->DuAn .'] Đã nghiệm thu '. $this->_params->SoPhieu;

                $body  = '<h1>Đã nghiệm thu '. $this->_params->SoPhieu.'</h1>';
