<?php
class Qss_Bin_Notify_Mail_M852_Inserted extends Qss_Lib_Notify_Mail
{
	const TYPE = 'TRIGGER';
	
	const TITLE = 'Gửi email khi tạo công việc';
	...
	public function __doExecute()
	{
		$domain = $_SERVER['HTTP_HOST'];
			...
			{
				$subject = '['. $this->_params->DuAn .'] Công việc mới tạo '. $this->_params->SoPhieu;

                $body  = '<h1>Công việc mới tạo '. $this->_params->SoPhieu.'</h1>';
