<?php
class Qss_Bin_Notify_Mail_M852_Step5 extends Qss_Lib_Notify_Mail
{
    const TITLE ='Gửi email khi hủy công việc';
    ...
    public function __doExecute($user,$status,$comment)
    {
        ...
        {
            $subject = '['. $this->_params->DuAn .'] Hủy '. $this->_params->SoPhieu;

            $body  = '<h1>Hủy '. $this->_params->SoPhieu.'</h1>';
